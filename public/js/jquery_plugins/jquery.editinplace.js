 ...
 * cancel_button (string) default: <input type=ΓÇ¥submitΓÇ¥ class=ΓÇ¥inplace_cancelΓÇ¥ value=ΓÇ¥CancelΓÇ¥/> image button tag to use as ΓÇ£CancelΓÇ¥ button
 * default_text (string) default: ΓÇ£(Click here to add text)ΓÇ¥ text to show up if the element that has this functionality is empty
 ...
 * field_type (string) ΓÇ£textΓÇ¥, ΓÇ£textareaΓÇ¥, or ΓÇ£selectΓÇ¥; default: ΓÇ£textΓÇ¥ The type of form field that will appear on instantiation
 * on_blur (string) ΓÇ£saveΓÇ¥ or null; default: ΓÇ£saveΓÇ¥ what to do on blur; will be overridden if $param show_buttons is true
 ...
 * save_button (string) default: <input type=ΓÇ¥submitΓÇ¥ class=ΓÇ¥inplace_saveΓÇ¥ value=ΓÇ¥SaveΓÇ¥/> image button tag to use as ΓÇ£SaveΓÇ¥ button
 * saving_image (string) default: uses saving text specify an image location instead of text while server is saving
 * saving_text (string) default: ΓÇ£SavingΓÇªΓÇ¥ text to be used when server is saving information
...
jQuery.fn.editInPlace = function(options) {
	...
	return this.each(function(){
		...
		.hover(
			function(){ jQuery(this).addClass(settings.hover_class); },
			function(){ jQuery(this).removeClass(settings.hover_class); }
		)
